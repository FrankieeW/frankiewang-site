    ...
    education: [
      {
        ...
        institution: "Imperial College London",
        note: "Department of Mathematics. Coursework and dissertation focused on algebra and number theory.",
      },
      {
        period: "—",
        degree: "Previous studies",
        institution: "To be added",
        note: "Undergraduate background — details coming soon.",
      },
    ],
    notes: [
      {
    ...
    education: [
      {
        ...
        degree: "MSc Pure Mathematics",
        institution: "Imperial College London",
        note: "Département de mathématiques. Cours et mémoire centrés sur l'algèbre et la théorie des nombres.",
      },
      {
        period: "—",
        degree: "Études antérieures",
        institution: "À compléter",
        note: "Parcours de premier cycle — détails à venir.",
      },
    ],
    notes: [
      {
